...
// at 2015-05-25 11:25:43.821822524 +0200 CEST
//
...
ExplainStmt:
	_EXPLAIN Statement
	{
		$$ = []ExplainStmt{"EXPLAIN", $2} //TODO 51
	}

Expression:
	Term Expression1
	{
		$$ = []Expression{$1, $2} //TODO 52
	}

Expression1:
	/* EMPTY */
	{
		$$ = []Expression1(nil) //TODO 53
	}
|	Expression1 Expression11 Term
	{
		$$ = append($1.([]Expression1), $2, $3) //TODO 54
	}
...
ExpressionList:
	...
	{
		$$ = []ExpressionList{$1, $2, $3} //TODO 57
	}

ExpressionList1:
	/* EMPTY */
	{
		$$ = []ExpressionList1(nil) //TODO 58
	}
|	ExpressionList1 ',' Expression
	{
		$$ = append($1.([]ExpressionList1), ",", $3) //TODO 59
	}
...
FieldList:
	...
	{
		$$ = []FieldList{$1, $2, $3} //TODO 77
	}

FieldList1:
	/* EMPTY */
	{
		$$ = []FieldList1(nil) //TODO 78
	}
|	FieldList1 ',' Field
	{
		$$ = append($1.([]FieldList1), ",", $3) //TODO 79
	}
...
GroupByClause:
	...
	{
		$$ = []GroupByClause{"GROUP BY", $2} //TODO 82
	}
...
InsertIntoStmt:
	...
	{
		$$ = []InsertIntoStmt{"INSERT", "INTO", $3, $4, $5} //TODO 85
	}
...
JoinClause:
	...
	{
		$$ = []JoinClause{$1, $2, "JOIN", $4, "ON", $6} //TODO 90
	}
...
Predicate1:
	...
	{
		$$ = []Predicate1{$1, $2} //TODO 116
	}
|	_IS Predicate13 _NULL
	{
		$$ = []Predicate1{"IS", $2, "NULL"} //TODO 117
	}
...
Predicate12:
	_IN '(' ExpressionList ')'
	{
		$$ = []Predicate12{"IN", "(", $3, ")"} //TODO 120
	}
|	_IN '(' SelectStmt Predicate121 ')'
	{
		$$ = []Predicate12{"IN", "(", $3, $4, ")"} //TODO 121
	}
|	_BETWEEN PrimaryFactor _AND PrimaryFactor
	{
		$$ = []Predicate12{"BETWEEN", $2, "AND", $4} //TODO 122
	}
...
PrimaryFactor:
	...
	{
		$$ = []PrimaryFactor{$1, $2} //TODO 132
	}

PrimaryFactor1:
	/* EMPTY */
	{
		$$ = []PrimaryFactor1(nil) //TODO 133
	}
|	PrimaryFactor1 PrimaryFactor11 PrimaryTerm
	{
		$$ = append($1.([]PrimaryFactor1), $2, $3) //TODO 134
	}
...
PrimaryTerm:
	...
	{
		$$ = []PrimaryTerm{$1, $2} //TODO 139
	}

PrimaryTerm1:
	/* EMPTY */
	{
		$$ = []PrimaryTerm1(nil) //TODO 140
	}
|	PrimaryTerm1 PrimaryTerm11 UnaryExpr
	{
		$$ = append($1.([]PrimaryTerm1), $2, $3) //TODO 141
	}
...
|	'.' _IDENTIFIER
	{
		$$ = []QualifiedIdent1{".", $2} //TODO 151
	}

RecordSet:
	RecordSet1 RecordSet2
	{
		$$ = []RecordSet{$1, $2} //TODO 152
	}
...
|	_AS _IDENTIFIER
	{
		$$ = []RecordSet2{"AS", $2} //TODO 158
	}

RecordSetList:
	RecordSet RecordSetList1 RecordSetList2
	{
		$$ = []RecordSetList{$1, $2, $3} //TODO 159
	}

RecordSetList1:
	/* EMPTY */
	{
		$$ = []RecordSetList1(nil) //TODO 160
	}
|	RecordSetList1 ',' RecordSet
	{
		$$ = append($1.([]RecordSetList1), ",", $3) //TODO 161
	}
...
SelectStmt:
	...
	{
		$$ = []SelectStmt{"SELECT", $2, $3, "FROM", $5, $6, $7, $8, $9, $10, $11} //TODO 165
	}
